...
const getNavLinks = () => [
  ...
  { to: "leadership-recruitment", label: "Leadership Recruitment" },
  { to: "lateral-recruitment", label: "Lateral Recruitment" },
  { to: "fresher-recruitment", label: "Fresher Recruitment" },
  { to: "rpo", label: "RPO (Shared Services)" },
];
...
const ItConsultingHeader = () => {
  ...
  useEffect(() => {
    const sectionTitles = {
      ...
      "leadership-recruitment": "Leadership Recruitment",
      "lateral-recruitment": "Lateral Recruitment",
      "fresher-recruitment": "Fresher Recruitment",
      rpo: "RPO (Shared Services)",
      home: "Home",
    };
        ...
        <nav className="hidden md:flex items-center gap-2 lg:gap-10 font-roboto">
          {navLinks.map(({ to, label }) => (
            <Link
              ...
              className={`cursor-pointer text-[#000] lg:text-md rounded-full transition duration-300  hover:text-[#fdbd1b] ${
                activeSectionHead === to ? "text-[#fdbd1b]" : ""
              }`}
            >
              {label}
            </Link>
