...
const ManagedITBenefits = ({ pageIndex }) => {
  ...
  return (
    <section className="bg-[#F5F5F5] py-10 px-4 md:px-10 font-sans">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        {/* === Left Text Content === */}
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-[#111218] mb-6 border-b-4 border-[#DEE0FF] inline-block pb-2">
            Benefits of Managed IT Services Provided by Tecnologia
          </h2>

          <div className="space-y-4 text-[#5F6567] mb-2">
            <p>
          ...
          <div className="grid gap-6 md:grid-cols-2 text-[#242627]">
            <div className="space-y-2">
              <h4 className="text-xl font-semibold text-[#101011] flex items-center">
            ...
            <div className="space-y-3">
              <h4 className="text-lg font-semibold text-[#101011] flex items-center">
                <AiOutlineCheckCircle className="text-[#dfe0e8] bg-[#010ED0] rounded-full mr-2" />
            ...
            <div className="space-y-3">
              <h4 className="text-lg font-bold text-[#101011] flex items-center">
                <AiOutlineCheckCircle className="text-[#dfe0e8] bg-[#010ED0] rounded-full mr-2" />
        ...
        {/* === Right Side Image === */}
        <div className="w-full h-full flex flex-column items-center justify-content-center">
          <img
            src={page.img2}
