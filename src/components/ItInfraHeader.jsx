...
const getNavLinks = () => [
  ...
  { to: "hardware-services", label: "Hardware" },
  { to: "networking-services", label: "Networking" },
  { to: "cloud-infrastructure", label: "Cloud & Infrastructure" },
  { to: "surveillance-security", label: "Surveillance Security" },
  { to: "printer-services", label: "Printer" },
  { to: "multimedia-services", label: "Multimedia" },
];
